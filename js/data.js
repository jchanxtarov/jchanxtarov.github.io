...
const TRANSLATIONS = {
  ...
  ja: {
    ...
    "news.items":[
      ...
      {date:"2026年2月",text:'ZOZO研究所 デプロイメント部 ディレクターに昇進しました。',isNew:true},
      {date:"2026年2月",text:'機械学習トップカンファレンス「ICLR 2026」に2本の論文が採択されました。',isNew:true},
      ...
      {date:"2025年",text:'COLM 2025に論文が採択されました。',isNew:false},
      {date:"2025年",text:'RecSys 2025（Late-Breaking Results）に論文が採択されました。',isNew:false},
      {date:"2025年",text:'ICME 2025（Oral）に論文が採択されました。',isNew:false},
      {date:"2024年",text:'LINEヤフーグループ 最優秀社員賞を受賞しました（27,000名以上の中から上位3名）。',isNew:false},
      {date:"2023年7月",text:'カリフォルニア大学サンディエゴ校 コンピュータサイエンス学部の客員研究員として着任しました。',isNew:false}
    ],
    "talks.title":"講演等",
